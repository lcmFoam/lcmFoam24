...
*/            
            ...
            solve
            (
                porosity*fvm::ddt(alpha1_)+ (fvm::div(fvc::flux(U), alpha1_) - fvm::SuSp(fvc::div(U),alpha1_) )  //working
                //porosity*fvm::ddt(alpha1_)+ (fvm::div(phi, alpha1_) )  //working
            );
            alpha1_=min(alpha1_,1.0);
            alpha1_=max(alpha1_,0.0); 
            alpha1=alpha1_;
            alpha2=1.0-alpha1;  
            //
            //Update mixture quantities 
